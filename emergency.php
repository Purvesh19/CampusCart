    ...
    <div class="container h-full flex">
        ...
        <div class="-ml-4 right basis-3/4 absolute left-1/4 w-3/4">
            <div class=" upper h-14 border-b-2 border-purple-600 flex justify-between  ">
                <h1 class="text-4xl mt-2 font-semibold">Your Emergency Buying/Renting Store</h1>
                ...
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            ...
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">₹350</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            ...
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">₹2100</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            ...
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">₹170</div>
                        </div>
                    </div>
                </a>
            </div>
