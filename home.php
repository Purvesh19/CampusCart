  ...
  <header class="justify-center items-center">
    <div class="flex navbar pt-2 h-16 bg-purple-950 p-2">
      <div class="logo flex items-center justify-center mx-6">
        ...
        <h1 class="items-center font-semibold text-white text-lg">
          <a href="home.html">Campus Cart</a>
        </h1>
      </div>
        ...
        <form>
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search"
              ...
              placeholder="Search for products - laptop, watch, notes..." required />
            <button type="submit"
      ...
      <div class="boxing">
        <div class="add dropdown cursor-pointer  rounded-md focus:outline-none">
          <svg class="h-10 w-10 text-purple-300 hover:shadow-white shadow-md mt-1" width="30" height="30"
        ...
        <div class="flex justify-end items-center text-white gap-2 ml-2">
          ...
          <img class="rounded-full border-2 border-sky-400"
            src="https://dspncdn.com/a1/media/692x/80/ae/44/80ae442a54a07b6619c3b742e47de046.jpg" height="50" width="50"
            alt="" />
          <a class="text-lg ml-2 border-slate-400 font-bold" href="/campuscart/index.php">SignOut</a>
          <!-- <svg
            class="w-6 h-6 ml-2 text-white-800 light:text-red-300 hover:text-red hover:translate-x-1"
            href="/campuscart/index.php"
            aria-hidden="true"
    ...
    <div class="nav-2 text-black bg-purple-100 py-2 pt-4 text-xl">
      <nav class="flex justify-center items-center gap-6 mx-12">
        <a class="text-blue-700 hover:bg-gray-300 p-2 px-4 rounded-md focus:outline-none"
          href="/campuscart/home.php">Home</a>
    ...
    <div class="carousel">
      <div class="carousel-inner object-cover">
        <a href="link1.html" class="carousel-item">
          <img src="https://cdn.discordapp.com/attachments/1120377338346090588/1122787372451495957/Red_and_Yellow_Opening_Announcement_Facebook_Ad.png" alt="Image 1" />
        </a>
