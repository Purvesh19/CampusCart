    ...
    <header class="justify-center items-center">
      ...
      <div class="nav-2 text-black bg-purple-100 py-2 pt-4 text-xl">
        <nav class="flex justify-center items-center gap-6 mx-12">
          ...
          <div
            class="dropdown2 cursor-pointer hover:bg-gray-200 p-2 px-4 rounded-md focus:outline-none"
          >
            Categories
            <ul
              class="flex flex-col gap-4 hidden2 z-20 absolute top-32 p-6 left-1/3 bg-purple-100 text-lg rounded-md"
            >
