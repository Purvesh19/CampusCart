...
<head>
    ...
    <!-- <link rel="shortcut icon" type="image/ico" href="//assets/logo-1-f3c60bcb.png"> -->
    <style>
...
<body>
    <div class="flex navbar pt-2 h-16 bg-purple-950 p-2">
        ...
        <div class="add dropdown cursor-pointer  rounded-md focus:outline-none">
          ...
          <ul
            class="flex flex-col gap-4 hidden z-20 absolute top-14 p-6 left-3/43 bg-purple-100 bg-opacity-70 text-lg rounded-md"
          >
        ...
        <div class="flex justify-end items-center text-white gap-2 ml-2">
          ...
          <!-- <svg
            class="w-6 h-6 ml-2 text-gray-800 dark:text-gray-300 hover:text-white hover:translate-x-1"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 16 16"
    ...
    <div class="container h-full flex">
        ...
        <div class="-ml-4 right basis-3/4 absolute left-1/4 w-3/4">
            <div class=" upper h-14 border-b-2 border-purple-600 flex justify-between  ">
                <h1 class="text-4xl mt-2 font-semibold">Donations - help the needy</h1>
                ...
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            <div class="basis-1/3">
                                <img src="https://cdn.discordapp.com/attachments/1118765599892455464/1122771108358258718/engineering-mini-drafter.png" alt=""
                                    class="w-full mx-4 my-2 mb-4 rounded-sm h-64 object-cover">
                            </div>
                            <div class="mx-4 basis-2/3">
                                <h1 class="text-2xl font-semibold">Steel Engineering Mini Drafter, For Drawing</h1>
                                <ul class="list-disc ml-6">
                                    <li class="text-gray-500">Usage/Application - Drawing</li>
                                    <li class="text-gray-500">Material	- Steel</li>
                                    <li class="text-gray-500">Brand	- Natraj</li>
                                    <li class="text-gray-500">Country of Origin	- Made in India</li>
                                    <li class="text-gray-500">Posted on 12/12/2021</li>
                                </ul>
                                <button
                                    class="px-8 mt-4 mb-4 py-2 text-xl font-medium bg-purple-700 text-white rounded-md hover:bg-purple-600"><a
                                        href="/campuscart/product_details.php">View<span
                                            class="z-10 font-medium text-xl hover:translate-x-1">>></a></span> </button>
                            </div>
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4"><s>₹250</s></div>
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">Free</div>
                        </div>
                    </div>
                </a>
            </div>
            <div class="card mt-4 h-auto shadow-md">
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            <div class="basis-1/3">
                                <img src="https://cdn.discordapp.com/attachments/1118765599892455464/1122773255305035837/fx-991ESPLUS.png" alt=""
                                    class="w-full mx-4 my-2 mb-4 rounded-sm h-64 object-cover">
                            </div>
                            <div class="mx-4 basis-2/3">
                                <h1 class="text-2xl font-semibold">fx-991ES PLUS | ES PLUS Series -Non Programmable- | SCHOOL & LAB. | Calculators | CASIO</h1>
                                <ul class="list-disc ml-6">
                                    <li class="text-gray-500">New equation mode</li>
                                    <li class="text-gray-500">Integration/differential calculations</li>
                                    <li class="text-gray-500">Non Programmable</li>
                                    <li class="text-gray-500">Comes with new slide-on hard case</li>
                                    <li class="text-gray-500">Posted on 12/12/2021</li>
                                </ul>
                                <button
                                    class="px-8 mt-4 mb-4 py-2 text-xl font-medium bg-purple-700 text-white rounded-md hover:bg-purple-600"><a
                            ...
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4"><s>₹1,500</s></div>
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">Free</div>
                        </div>
                    </div>
                </a>
            ...
            <div class="card mt-4 h-auto shadow-md">
                <a href="#">
                    <div class="card-body">
                        <div class="flex gap-4">
                            <div class="basis-1/3" style="width:256px">
                                <img src="https://cdn.discordapp.com/attachments/1118765599892455464/1122775132000243833/45a49d46445b43c1d6235d7e4397a509.png" alt=""
                                    class="w-full mx-4 my-2 mb-4 rounded-sm h-64 object-cover">
                            </div>
                            <div class="mx-4 basis-2/3">
                                <h1 class="text-2xl font-semibold">Physics Notes | Class 12 | NCERT Syllabus » SCIENCE CAREER COACHING</h1>
                                <ul class="list-disc ml-6">
                                    <li class="text-gray-500">Physics Handwritten Notes</li>
                                    <li class="text-gray-500">NCERT Syllabus</li>
                                    <li class="text-gray-500">Best for JEE/NEET</li>
                                    <li class="text-gray-500">Recommended</li>
                                    <li class="text-gray-500">Posted on 12/12/2021</li>
                                </ul>
                                <button
                                    class="px-8 mt-4 mb-4 py-2 text-xl font-medium bg-purple-700 text-white rounded-md hover:bg-purple-600"><a
                            ...
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4"><s>₹150</s></div>
                            <div class="price font-bold text-5xl justify-self-center mt-4 mr-4">Free</div>
                        </div>
                    </div>
                </a>
