      ...
      <div class="container px-4 mx-auto">
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            <div
              class="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-center xl:items-center"
            >
              <div
                class="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-start"
              >
                <a
              ...
              <div class="w-full sm:w-9/12 px-4">
                <img class="mb-5" src="https://picsum.photos/600/600" alt="" />
                <p class="text-sm text-gray-300">Roll over image to zoom in</p>
              </div>
              <div class="w-40  px-2 mb-2 md:mb-0" style="margin-left:261px">
                <a
                  class="block mx-16 py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl"
                  href="/campuscart/360/360.php"
                  >360 View</a>
              </div>
              <div class="w-40  px-2 mb-2 md:mb-0" style="margin-left:261px">
                <a
                  class="block mx-16 py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl"
                  href="/campuscart/Chatbox/chatbox.php"
                  >Chat with Seller</a
                >
              </div>
            </div>
          ...
          <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-md mb-2">
              <span class="text-xs text-gray-400 tracking-wider"
                >product #3299803</span
              >
              <h2
                class="mt-2 mb-4 text-xl md:text-2xl lg:text-4xl font-heading font-medium"
              >
            ...
            <div>
              ...
              <button
                class="flex w-full pl-6 lg:pl-12 pr-6 py-4 mb-4 justify-between items-center leading-7 rounded-2xl border-2 border-blueGray-200 hover:border-blueGray-300"
              >
              ...
              <button
                class="flex w-full pl-6 lg:pl-12 pr-6 py-4 justify-between items-center leading-7 rounded-2xl border-2 border-blueGray-200 hover:border-blueGray-300"
              >
                <h3 class="text-lg font-heading font-medium">
